 ...
 */
class Promotor extends CActiveRecordExt {
    ...
    public function attributeLabels() {
        return array(
            ...
            'code_phone_office' => 'Code Phone Office',
            'number_phone_office' => 'Number Phone Office',
            'code_phone_personal' => 'Code Phone Personal',
            'number_phone_personal' => 'Number Phone Personal',
            'date' => 'Fecha',
            'time' => 'Hora',
    ...
    public static function getEstatus($id) {
        ...
        $lista = array(
            1 => '<span class="label label-default">Pendiente</span>',
            2 => '<span class="label label-primary">En proceso</span>',
            3 => '<span class="label label-danger">Negado</span>',
            4 => '<span class="label label-warning">Anulado</span>',
            5 => '<span class="label label-success">Procesado</span>',
        );
