...
class AdminpromotorController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', /* Acciones Permitidas */
                'actions' => array('index', 'view', 'create', 'update', 'follow', 'delete', 'listmunicipalities', 'listparishes'),
                'users' => array('*'),
            ),
            array('deny',
                'users' => array('*'),
    ...
    public function actionFollow($id) {
        ...
        if (Yii::app()->authRBAC->checkAccess($this->modulo . '_follow')) {
            ...
            $consulta = Promotor::model()->find($sql);
