...
class FavoritesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UsersFavorites']))
		{
			$model->attributes=$_POST['UsersFavorites'];
			if($model->save()){
	...
	public function actionIndex()
	{
		...
		$model=new UsersFavorites('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UsersFavorites'])){
			$model->attributes=$_GET['UsersFavorites'];
                        }
	...
	{       
                ...
                $dataProvider=new CActiveDataProvider('UsersFavorites');
	 ...
	 * @return UsersFavorites the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=UsersFavorites::model()->find(array('condition'=>'id = :id','params'=>array(':id'=>$id)));
		if($model===null)
	 ...
	 * @param UsersFavorites $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='users-favorites-form')
		{
